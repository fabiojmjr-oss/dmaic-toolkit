...
(`FORNO-CURA`, with its factors and levels). The reference values the gages are measured against are invented too, and are exact by construction: a real calibrated master carries its own uncertainty, and that limitation is stated in the module documentation rather than hidden. None of these are references to any real instrument,
