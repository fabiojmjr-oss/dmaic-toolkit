# `dmaic.control` — what the plan guarantees

*[Português](#dmaiccontrol--o-que-o-plano-garante)*
...
# `dmaic.control` — o que o plano garante

*[English](#dmaiccontrol--what-the-plan-guarantees)*
