# `dmaic.measure` — measurement system analysis (precision)

*[Português](#dmaicmeasure--análise-do-sistema-de-medição-precisão)*
...
# `dmaic.measure` — análise do sistema de medição (precisão)

*[English](#dmaicmeasure--measurement-system-analysis-precision)*
